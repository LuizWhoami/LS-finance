...
urlpatterns = [
    ...
    path('transacoes/<int:pk>/', views.TransactionDetailView.as_view(), name='transaction_detail'),
    path('transacoes/<int:pk>/editar/', views.TransactionUpdateView.as_view(), name='transaction_edit'),
